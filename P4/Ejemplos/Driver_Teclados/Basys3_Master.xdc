...
#set_property PACKAGE_PIN V2 [get_ports {COLOR[8]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {COLOR[8]}]
#set_property PACKAGE_PIN T3 [get_ports {COLOR[9]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {COLOR[9]}]
#set_property PACKAGE_PIN T2 [get_ports {COLOR[10]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {COLOR[10]}]
#set_property PACKAGE_PIN R3 [get_ports {COLOR[11]}]					
...
#set_property PACKAGE_PIN V13 [get_ports {ascii_code[4]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {ascii_code[4]}]
